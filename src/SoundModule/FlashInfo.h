...
#define HEADER_PAGE_NUM_EX_V2       2
#define HEADER_COUNT_MAX_EX_V2      15

#define SOUNDMODULE_RATE            46875
#define SOUNDMODULE_HEADER_START_PAGE   0
#define SOUNDMODULE_HEADER_COUNT_MAX HEADER_COUNT_MAX_EX_V2
#define SOUNDMODULE_SAMPLE_START_PAGE   (SOUNDMODULE_HEADER_START_PAGE + HEADER_PAGE_NUM_EX_V2)
